        ...
        <ul className="nav nav-tabs align-items-stretch nav-fill bg-white pt-2 font-weight-bold px-3">
          <div className="container p-0 px-md-3 d-flex">
            <li className="nav-item">
              <a className="nav-link active bg-light" id="tasks-tab" data-nav="tasks" style={{ height: '100%' }}>Tasks</a>
            </li>
            <li className="nav-item">
              <a className="nav-link text-primary" id="jobs-tab" data-toggle="collapse" data-nav="jobs" style={{ height: '100%' }}>Groups</a>
            </li>
          </div>
        </ul>
      </div>
          ...
          <div className="col-12">
            <div className="mb-3">
              <div className="d-flex">
                <div className="px-0">
                  <h4 className="mt-1">Tasks </h4>
                </div>
                <div className="col px-0 text-right">
                  <button id="batch-actions-toggle" style={{ display: 'none' }} className="btn btn-outline-primary mr-2" role="button" data-toggle="collapse" href="#batch-menu" aria-expanded="false" aria-controls="batch-menu">
                    <i className="fas fa-th" aria-hidden="true"></i>
                    <span className="sr-only">Batch Actions</span>
                  </button>
                  {showEye && <button disabled="" className="btn btn-outline-secondary ml-2" role="button" data-toggle="collapse" href="#task-tab-view" aria-expanded="false" aria-controls="task-tab-view">
                  ...
                  <button disabled="" className="btn btn-outline-secondary ml-2" role="button" data-toggle="collapse" href="#task-filters" aria-expanded="false" aria-controls="task-filters">
              ...
              <div className="col-6 pl-0">
                <div className="form-group mb-2">
                  ...
                  <select id="filter-sort-task" className="selectpicker form-control" data-dropup-auto="false" data-style="bg-white">
                    <option data-subtext="Newest First" value="">Created</option>
...
TaskLoader.defaultProps = {
  showEye: true,
};

TaskLoader.displayName = 'LocationDetailsTaskLoader';
